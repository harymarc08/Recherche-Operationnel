...
// Algorithme de Dijkstra classique pour trouver le chemin minimal
function dijkstraMinDistance(
  graph: GraphData,
  startNode: string,
  endNode?: string
): {
...
const EdgeModal: React.FC<EdgeModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-emerald-900/60 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-xl shadow-xl w-96 max-w-lg">
        <h2 className="text-xl font-bold mb-4 text-emerald-800 border-b pb-2">
        ...
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full border border-gray-300 p-2 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-gray-900"
            >
...
export default function DijkstraPage() {
  ...
  // Utilisation des hooks de ReactFlow
  ...
  // Mettre à jour les arêtes lorsque le chemin change
  useEffect(() => {
  ...
  // Calculer le chemin minimal
  const calculateMinPath = () => {
    const result = dijkstraMinDistance(graph, startNode, endNode);
  ...
  return (
    <div className="container mx-auto p-6 bg-gray-50 min-h-screen">
      <div className="bg-white rounded-xl shadow-md p-6 mb-6">
        <div className="flex justify-between items-center mb-4 border-b pb-3">
          <h1 className="text-2xl font-bold text-emerald-800">
            Algorithme de Dijkstra - Chemin Minimal
          </h1>
          ...
          <div className="bg-emerald-50 p-4 rounded-lg shadow-sm">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              <select
                ...
                className="border border-emerald-300 bg-white p-2 rounded-lg text-gray-900 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all"
              >
                {nodes.map((node) => (
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-emerald-50 p-4 rounded-lg shadow-sm border border-emerald-100">
            <h2 className="font-semibold mb-3 text-emerald-800 flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 mr-2"
                viewBox="0 0 20 20"
            ...
            <div className="overflow-auto max-h-64 bg-white rounded-lg border border-emerald-100">
              {nodes.length === 0 ? (
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-emerald-50">
                    <tr>
                      <th className="px-4 py-2 text-left text-xs font-medium text-emerald-800 uppercase tracking-wider">
                        ID
                      </th>
                      <th className="px-4 py-2 text-left text-xs font-medium text-emerald-800 uppercase tracking-wider">
                        Position
                      </th>
                      <th className="px-4 py-2 text-right text-xs font-medium text-emerald-800 uppercase tracking-wider">
                        Actions
                      </th>
                    </tr>
                  </thead>
                  <tbody className="bg-white divide-y divide-gray-200">
                    {nodes.map((node) => (
                      ...
                      >
                        <td className="px-4 py-2 whitespace-nowrap font-medium text-emerald-700">
                          {node.id}
                        </td>
      ...
      <footer className="text-center text-gray-500 mt-8 pb-4">
        <p>Algorithme de Dijkstra - Version chemin minimal</p>
        <p className="text-sm mt-1">
          © {new Date().getFullYear()} - Armel Rantomahampy
        </p>
      </footer>
    </div>
  );
